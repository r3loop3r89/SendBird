...
public class GuestMessagesRecyclerViewAdapter extends RecyclerView.Adapter<GuestMessagesRecyclerViewAdapter.GMRVAViewHolder> {

    List<UserMessage> l;
    SharedPreferencesManager s;

    public GuestMessagesRecyclerViewAdapter(Context context, List<UserMessage> l) {
        this.l = l;
    ...
    public void onBindViewHolder(GMRVAViewHolder holder, int position) {
        ...
        if (um.getSender().getUserId().equals(s.getGuestId())){
